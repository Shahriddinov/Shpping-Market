      ...
      <section className="profile__page">
        ...
        <div className="forms">
          ...
          <div className="d-flex">
            <div className="qualficationLeft">
              <div className="form">
                <FormControl sx={{ minWidth: "100%" }} size="small">
                  <InputLabel className="mt-1" id="demo-select-small">
                    {t("region")}
                  </InputLabel>
                  <Select
            ...
            <div className="qualficationRight">
              <div className="form">
                <Box sx={{ minWidth: "500px", mb: 3 }}>
                  <TextField
                    label={t("direction")}
                    name="direction"
                    type="text"
        ...
        <div className="next-page">
          <div className="back-btn">
            <Stack spacing={2} direction="row">
              <Button className="button" href="/work" variant="contained">
                <span className="icon">
