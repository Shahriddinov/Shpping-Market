...
function CategoryId({item, IdCategory}) {
    ...
    function deletePdf() {
        axios.delete(`${baseApi}/check/${directionCategoryId}/delete`, {
            headers: {
                "Accept-Language": localStorage.getItem("lng",) || "uz"
            }
        }).then((response) => {
    ...
    return (
        <div className="toTeach" key={item.id}>
            <h3 className="itemTitle">{item?.category_ru ?? item?.category_uz ?? item?.category_en}</h3>
            <div className="formBox">
                <form action="" className="forma">
                    {item?.sub_category?.map((i, index) => (
                        ...
                        <div className="variants" key={index.toString()}>
                            ...
                            </div> : item?.category_ru && i.name_ru ?
                            ...
                            </div> : item?.category_en && i.name_en ?
                ...
                <div className="d-flex align-items-center">
                    ...
                    {
                        check ? <div className="imgsPdf" onClick={deletePdf}>
