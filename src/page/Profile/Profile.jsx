...
function Profile() {
    ...
    function personalInfo() {
        ...
        axios.post(`${baseApi}/personal`, info, {
            headers: {
                ...
                <div className="Page1">
                    ...
                    <form action="post" className="page1__form">
                        <div className="page1__form-left w-50">
                            ...
                            >
                                <input type="radio" className="womenInput" name="gender" id="women" value="women"
                                       onChange={(e) => setGender(e.target.value)}/>
                                <label htmlFor="women" className="women">{t("women")}</label>
                                <input type="radio" className="womenInput" name="gender" id="man" value="man"
                                       onChange={(e) => setGender(e.target.value)}/>
                                <label htmlFor="man" className="women">{t("man")}</label>
                            </FormGroup>
