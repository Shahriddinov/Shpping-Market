...
function PersonalInfo({obj, imageURL}) {
    ...
    useEffect(() => {
        axios.get('https://sport.napaautomotive.uz/api/allData/'+id).then((response) => {
                ...
                <div className="personaly">
                    <div className="personalLeft">
                        ...
                        <div className="form-group">
                            ...
                            <div className="nationInfo">{education.education_name_ru ?? education.education_name_en ?? education.education_name_uz ?? ""}</div>
                        </div>
                        <div className="form-group">
