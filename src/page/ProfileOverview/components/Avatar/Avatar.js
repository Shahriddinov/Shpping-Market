...
function Avatar(props) {
    ...
    imgUpload = (v) => {
        ...
        axios.post(`${baseApi}/avatar`, formData)
            .then(res => {
    ...
    function deleteImg() {
        axios.delete(`${baseApi}/avatar/${imgId}/delete`, {
            headers: {
    ...
    return (
        <div className="avatar">
            <h5>{photoError}</h5>
            {/*<h4>{photos}</h4>*/}
            <img className="defaultImg" onClick={deleteImg} src={photos ? `https://sport.napaautomotive.uz/storage/${photos}` : Imgs}
                 alt="avatar"/>
